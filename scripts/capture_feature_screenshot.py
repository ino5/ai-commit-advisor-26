...
SCENARIOS: dict[str, FeatureScenario] = {
    ...
    "risk-analysis": FeatureScenario(
        ...
        required_texts=(
            "Risk Analysis",
            "최신 프로그램 단위 구현상태를 비교해 점검할 위험 신호를 규칙으로 찾습니다.",
            "전체 리스크",
            "MEDIUM",
            "리스크 유형",
            "계획 대비 AI 진척 차이",
        ),
        forbidden_texts=("LLM 매핑 결과를 기반으로 누락/위험 프로그램",),
    ...
    "ai-progress": FeatureScenario(
        ...
        required_texts=(
            "AI Progress",
            "계획 진척도와 최신 프로그램 단위 구현상태 분석을 비교하고 리스크를 추적합니다.",
            "계획 진척도 평균",
            "AI 진척도 평균",
            "진척도 차이",
            "프로그램 단위 구현상태 분석",
        ),
        forbidden_texts=("LLM 매핑 결과 기반 AI 진척도",),
    ...
    "project-chat-answer": FeatureScenario(
        ...
        sidebar_label="Project Chat",
        wait_text="PaymentController, PaymentService, OrderStatusService",
        required_texts=(
            "Project Chat",
            "PaymentController, PaymentService, OrderStatusService",
            "PaymentService.java",
        ...
        forbidden_texts=("Mock answer", "fallback=True"),
        default_screenshot="docs/images/features/project-chat-answer.png",
        description="Project Chat 답변/근거 화면",
        scroll_to_text="PaymentController, PaymentService, OrderStatusService",
    ),
    ...
    "ai-code-review": FeatureScenario(
        ...
        forbidden_texts=("플라이어널", "PaymentPilotAuthorizationRiskTest 클래스 추가"),
