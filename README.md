...
![Developer Upload Validation](docs/images/features/developer-upload-validation.png)
...
![Program Upload Validation](docs/images/features/program-upload-validation.png)
...
![Development Plan Upload Validation](docs/images/features/development-plan-upload-validation.png)
...
![Commit Impact Summary](docs/images/features/commit-impact-summary.png)

상세 분석

![Commit Impact Detail](docs/images/features/commit-impact-detail.png)
...
![Project Chat](docs/images/features/project-chat.png)
...
![AI Code Review Result](docs/images/features/ai-code-review-result.png)

리뷰 상세

![AI Code Review Detail](docs/images/features/ai-code-review-detail.png)
...
- 사용 중: 샘플 대상 repo 생성/데이터 생성 스크립트 (`scripts/create_sample_target_repo.py`, `scripts/generate_sample_development_data.py`)
...
```text
프로젝트명: Sample Shop
로컬 Git 저장소 경로: C:\dev\ai-advisor-sample-shop
```
...
```powershell
.\.venv\Scripts\python.exe scripts\generate_sample_development_data.py --repo-path C:\dev\ai-advisor-sample-shop --output-dir sample_data
```

저장소 루트의 기존 프로그램 목록 CSV를 우선 사용하려면:

```powershell
.\.venv\Scripts\python.exe scripts\generate_sample_development_data.py --repo-path C:\dev\ai-advisor-sample-shop --output-dir sample_data --use-existing-program-csv --program-csv-path C:\dev\ai-advisor-sample-shop\샘플_프로그램목록.csv
```
