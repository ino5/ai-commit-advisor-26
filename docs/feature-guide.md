...
6. 표준용어/표준단어 화면에서 SI 산출물 Excel을 업로드해 한글 업무 용어와 코드 식별자를 연결합니다.
7. Mapping 화면에서 커밋 기준 분석을 먼저 실행합니다.
8. Program Detail, Commit Impact, Risk Analysis, AI Progress에서 분석 결과를 검토합니다.
9. RAG Search와 Project Chat에서 현재 소스 기반 근거 검색과 질의응답을 확인합니다.
10. AI Code Review에서 작업트리, staged 변경, 최신 commit, 특정 commit을 리뷰합니다.
